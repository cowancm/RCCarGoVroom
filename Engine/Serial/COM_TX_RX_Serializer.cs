...
{
    public class COM_TX_RX_Serializer
    {
        ...
        public COM_TX_RX_Serializer(BAUD_RATE baudEnum = BAUD_RATE.OneHundredFifteenThousandTwoHundred, Parity Parity = Parity.None, string DeviceName = "Silicon Labs CP210x USB to UART Bridge")
        {
            _COMPort = null;
